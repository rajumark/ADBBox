...
import com.adbstudio.desktop.feature.devicesettings.presentation.DeviceSettingsEvent
import com.adbstudio.desktop.feature.devicesettings.presentation.DeviceSettingsViewModel
import com.adbstudio.desktop.feature.devicesettings.presentation.SettingsTab
...
fun DeviceSettingsScreen(
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = { viewModel.onEvent(DeviceSettingsEvent.Refresh) },
        ...
        TabRow(selectedTabIndex = state.currentTab.ordinal) {
            SettingsTab.entries.forEach { tab ->
                Tab(
                    ...
                    onClick = { viewModel.onEvent(DeviceSettingsEvent.SetTab(tab)) },
                    text = { Text(tab.label) },
                )
            }
        }
        ...
        OutlinedTextField(
            ...
            onValueChange = { viewModel.onEvent(DeviceSettingsEvent.SetSearchQuery(it)) },
            modifier = Modifier.fillMaxWidth(),
            ...
            Row(
                ...
                columns.forEach { column ->
                    Text(
                        ...
                        modifier = Modifier.width(if (column == "Key") 280.dp else 400.dp),
                        maxLines = 1,
